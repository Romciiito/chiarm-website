  ...
  home: {
    ...
    grid: {
      ...
      cards: [
        ...
        { title: "Offline Operation",    desc: "Works without an internet connection after setup. Your CRM is always available, even without Wi-Fi.",            badge: undefined },
      ],
    },
    trust: {
      tag: "Privacy promise",
    ...
    faq: {
      ...
      items: [
        { q: "Is CHIARM really free to download?",            a: "CHIARM is free to download and evaluate. Continued use requires a subscription starting at 279€/month + VAT. Enterprise pricing is available for large teams — contact us." },
  ...
  pricing: {
    ...
    plans: [
      ...
      },
      {
        ...
        features: ["Up to 5 Telegram accounts","AI smart replies","Conversation summaries","Voice cloning","Message templates","Anti-spam engine","Local analytics","Owner + manager + chatter roles","Multi-account dashboard","macOS desktop app","Priority email support"],
        missing: [] as string[],
      },
      {
        name: "Enterprise",
        ...
        badge: undefined as string | undefined,
        features: ["Unlimited Telegram accounts","All Team features","WhatsApp (coming soon)","Instagram DMs (coming soon)","Custom integrations","Dedicated onboarding","SLA & uptime guarantee","Invoice billing"],
        missing: [] as string[],
      },
    ],
    vatNote: "/month + VAT",
    ...
    faqs: [
      { q: "Is there a free trial?",                  a: "Yes — download CHIARM and evaluate it for free. A subscription is required to continue using it after the trial period." },
...
const cs = {
  ...
  home: {
    ...
    grid: {
      ...
      cards: [
        ...
        { title: "Offline provoz",      desc: "Po nastavení funguje bez připojení k internetu. Váš CRM je vždy dostupný, i bez Wi-Fi.",                       badge: undefined },
      ],
    },
    trust: {
    ...
    faq: {
      ...
      items: [
        { q: "Je CHIARM skutečně ke stažení zdarma?",           a: "CHIARM je zdarma ke stažení a vyzkoušení. Další používání vyžaduje předplatné od 279 €/měsíc + DPH. Podnikové ceny jsou k dispozici pro velké týmy — kontaktujte nás." },
  ...
  pricing: {
    ...
    plans: [
      { name: "Solo",       desc: "Pro jednotlivé operátory provozující Telegram kampaně.",          cta: "Začít",              period: "měsíc",   badge: undefined as string | undefined, features: ["1 Telegram účet","Chytré odpovědi AI","Shrnutí konverzací","Šablony zpráv","Ochrana proti spamu","Lokální analytika","Desktopová aplikace pro macOS","Podpora e-mailem"], missing: ["Klonování hlasu","Týmové role","Více účtů","Prioritní podpora"] },
      { name: "Team",       desc: "Pro malé týmy spravující více Telegram účtů.",                   cta: "Začít",              period: "měsíc",   badge: "Nejoblíbenější" as string | undefined, features: ["Až 5 Telegram účtů","Chytré odpovědi AI","Shrnutí konverzací","Klonování hlasu","Šablony zpráv","Ochrana proti spamu","Lokální analytika","Role vlastník + manažer + chattér","Přehled více účtů","Desktopová aplikace pro macOS","Prioritní podpora e-mailem"], missing: [] as string[] },
      { name: "Enterprise", desc: "Vlastní nasazení pro velké týmy a agentury.",                    cta: "Kontaktovat obchod", period: undefined as string | undefined, badge: undefined as string | undefined, features: ["Neomezený počet Telegram účtů","Vše z plánu Team","WhatsApp (brzy)","Instagram DM (brzy)","Vlastní integrace","Dedikované zapracování","SLA a záruka dostupnosti","Fakturační platba"], missing: [] as string[] },
    ],
    vatNote: "/měsíc + DPH",
    customPrice: "Na míru",
    ...
    faqs: [
      { q: "Je k dispozici zkušební verze?",           a: "Ano — stáhněte si CHIARM a vyzkoušejte zdarma. Po uplynutí zkušební doby je k dalšímu používání vyžadováno předplatné." },
